...
import { PayContractByCrediter, PayContractToken } from "../typechain-types";
import { SignerWithAddress } from "@nomiclabs/hardhat-ethers/signers";

describe("Pay Contract By Crediter", function () {

    let payContractToken: PayContractToken;
    ...
    beforeEach(async function() {
        ...
        payContractToken = await ethers.deployContract("PayContractToken", ['DollarTest', 'DTS'], owner) as PayContractToken;
